...
export const FALLBACK_PLANS: PricingPlan[] = [
  { id: 'free', tier: 'free', name: 'Free', priceCents: 0, billingPeriod: null, features: ['ClearVoice grammar reconstruction', 'Sensory HUD', 'One acoustic trigger', 'Community support'] },
  { id: 'pro_monthly', tier: 'pro', name: 'Pro Monthly', priceCents: 1499, billingPeriod: 'monthly', features: ['Everything in Free', 'DAF / FSF Fluency Coach', 'Unlimited triggers', 'Caregiver link', 'Session analytics'] },
